...
class lora_receive_file_nogui(gr.top_block):
    def __init__(self):
        ...
        self.sf = sf = 10
        self.bw = bw = 125000
        self.target_freq = target_freq = 434.175e6
        self.symbols_per_sec = symbols_per_sec = float(bw) / (2**sf)
        self.sample_rate = sample_rate = 1e6
        self.decimation = decimation = 1
        self.capture_freq = capture_freq = 434.175e6
        ...
        self.lora_receiver = lora.lora_receivertmp(sample_rate, capture_freq, ([lora_config.freq]), lora_config.bw, lora_config.sf, lora_config.implicit, lora_config.cr_num, lora_config.crc, reduced_rate=False, decimation=self.decimation)
        ...
        self.connect((self.osmosdr_source_0, 0), (self.blocks_throttle, 0))
        self.connect((self.blocks_throttle, 0), (self.lora_receiver, 0))

if __name__ == '__main__':
    tb = lora_receive_file_nogui()
    tb.start()
    tb.wait()
