...
%     signal_detect = [signal_detect(windowsOffset+1 : end), zeros(1,windowsOffset)];
...
%         write_signal_to_file(signal(1:end), strcat('E:\share\aligned\',string(fileCount),'.sigmf-data'));
    end
end
