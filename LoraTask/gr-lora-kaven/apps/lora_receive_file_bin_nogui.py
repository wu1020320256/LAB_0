...
class lora_receive_file_nogui(gr.top_block):
    def __init__(self, sample_file, sample_rate, capture_freq, lc):
        ...
        self.lora_receiver = lora.lora_receivertmp(sample_rate, capture_freq, ([lc.freq]), lc.bw, lc.sf, lc.implicit, lc.cr_num, lc.crc, reduced_rate=False, decimation=self.decimation)
