...
class lora_receive_file_nogui(gr.top_block):
    def __init__(self):
        ...
        self.lora_receiver = lora.lora_receiver(sample_rate, capture_freq, ([lora_config.freq]), lora_config.bw, lora_config.sf, lora_config.implicit, lora_config.cr_num, lora_config.crc, reduced_rate=False, decimation=self.decimation)
